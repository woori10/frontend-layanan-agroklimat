                ...
                <div className="flex-1 w-full max-w-lg lg:max-w-none">
                    <div className="grid grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            {/* Image 1: Top-Left */}
                            <div className="overflow-hidden rounded-tl-[3.5rem] rounded-br-[1rem] shadow-lg border border-zinc-200/50 dark:border-zinc-800">
                                <img
                            ...
                            {/* Image 3: Bottom-Left */}
                            <div className="overflow-hidden rounded-bl-[3.5rem] rounded-tr-[1rem] shadow-lg border border-zinc-200/50 dark:border-zinc-800">
                                <img
                        ...
                        <div className="space-y-4 sm:space-y-6 pt-8 sm:pt-12">
                            {/* Image 2: Top-Right */}
                            <div className="overflow-hidden rounded-tr-[3.5rem] rounded-bl-[1rem] shadow-lg border border-zinc-200/50 dark:border-zinc-800">
                                <img
                            ...
                            <div className="overflow-hidden rounded-br-[3.5rem] rounded-tl-[1rem] shadow-lg border border-zinc-200/50 dark:border-zinc-800">
                                <img
