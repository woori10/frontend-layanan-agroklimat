...
export interface RekomendasiSNIStep2 {
  jenisData: string;
  alasan: string;
}
...
interface RekomendasiSNIStep2FormProps {
  onBack: () => void;
  onSubmit: (data: RekomendasiSNIStep2) => void;
  loading: boolean;
  initialData?: RekomendasiSNIStep2;
}

export default function RekomendasiSNIStep2Form({
  onBack,
  onSubmit,
  loading,
  initialData,
}: RekomendasiSNIStep2FormProps) {
