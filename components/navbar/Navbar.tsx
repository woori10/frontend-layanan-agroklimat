...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 w-full border-b border-zinc-200/40 bg-[#F3FCEB]/95 backdrop-blur-sm dark:bg-zinc-900/80 dark:border-zinc-800/40">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <div className="flex items-center gap-4">
                <button className="relative rounded-xl bg-white border border-zinc-200 p-2 text-zinc-500 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-800 cursor-pointer">
              ...
              <>
                <Link
                  href="/register"
                  className="rounded-full bg-white px-5 py-2 shadow-lg text-sm font-semibold text-[#2C5E3B] hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white px-3 py-2 transition"
                >
                  Register
                </Link>
                <Link
                  href="/login"
                  className="rounded-full bg-[#2C5E3B] px-5 py-2 text-sm font-semibold text-white shadow-md hover:bg-[#1E4329] transition-all duration-200"
                >
                  Login
                </Link>
              </>
