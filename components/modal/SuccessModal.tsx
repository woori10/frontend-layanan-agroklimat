    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 animate-in fade-in zoom-in-95 duration-200 text-center font-sans">
                ...
                {/* Icon */}
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400">
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="w-full py-2.5 px-4 text-xs font-semibold rounded-xl bg-green-color hover:bg-[var(--hover-green-color)] text-white transition shadow-sm cursor-pointer"
                    >
                        {confirmText}
                    </button>
                </div>
