    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(data.message || "Gagal menyimpan alat baru.");
            }

            router.push("/daftar-alat");
        } catch (err: any) {
            console.error(err);
            setError(err.message || "Terjadi kesalahan saat menyimpan data alat.");
        } finally {
            setSubmitting(false);
        }
    };
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex-1 space-y-2 pb-4 border-b border-b-zinc-200 dark:border-b-zinc-800">
                                    ...
                                    <p className="text-sm text-[var(--foreground)] dark:text-zinc-500">
                                        Lengkapi data alat laboratorium dan tarif peminjaman agar muncul pada formulir pengajuan peminjaman alat bagi publik.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Automatic Weather Station (AWS)"
