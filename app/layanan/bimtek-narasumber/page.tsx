...
const LAYANAN_ID = 17; // Bimbingan Teknis & Narasumber
      ...
      <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md rounded-2xl border border-zinc-200/60 dark:border-zinc-800/80 p-6 sm:p-8 shadow-xl relative overflow-hidden">
        ...
        {step === 1 ? (
          ...
          <ReviewServiceForm
            commonData={formData}
            serviceData={[
              { label: "Topik Pelatihan / Bimbingan", value: step2Data.jenisData, isLongText: true },
              { label: "Durasi Pelatihan", value: step2Data.alasan },
              { label: "Rencana Tanggal Pelaksanaan", value: step2Data.tanggalBimbingan }
            ]}
            onBack={() => setStep(2)}
