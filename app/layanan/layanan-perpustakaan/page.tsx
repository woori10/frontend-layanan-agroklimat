...
const LAYANAN_ID = 7; // Layanan Perpustakaan
        ...
        {success && (
          <div className="rounded-xl bg-emerald-50 p-6 text-sm text-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-400 border border-emerald-200/40 dark:border-emerald-900/40 flex flex-col items-center text-center gap-3 shadow-lg transition duration-300">
            ...
            <div className="space-y-1">
              <h3 className="text-lg font-bold text-emerald-900 dark:text-white">Pengajuan Kunjungan Berhasil!</h3>
              <p className="text-emerald-700 dark:text-emerald-400">
                Formulir kunjungan perpustakaan telah diajukan dengan nomor tiket <span className="font-extrabold text-emerald-900 dark:text-white">{createdTiketNo}</span>.
              </p>
